// Auto-generated from forge build output — V4 deploy 2026-02-25
...
export const ReputationSystemABI = [
  ...
  {
    "type": "function",
    "name": "PLATINUM_MIN_COUNTERPARTIES",
    "inputs": [],
    "outputs": [
      {
        "name": "",
  ...
  {
    "type": "function",
    "name": "SILVER_MIN_COUNTERPARTIES",
    "inputs": [],
    "outputs": [
      {
        "name": "",
  ...
  },
  {
    ...
    "outputs": [
      ...
      },
      {
        "name": "tier",
        "type": "uint8",
        "internalType": "enum IReputationSystem.ReputationTier"
      }
    ],
    "stateMutability": "view"
  },
    ...
    "outputs": [
      {
        "name": "",
        "type": "uint8",
        "internalType": "enum IStakingManager.Tier"
      }
    ],
    "stateMutability": "view"
  },
...
export const SybilGuardABI = [
  ...
  {
    "type": "function",
    "name": "setDisputeArbitration",
    "inputs": [
      {
        "name": "_disputeArbitration",
        "type": "address",
        "internalType": "address"
      }
    ],
  ...
  {
    "type": "function",
    "name": "watcherLastReportTimestamp",
    "inputs": [
      {
        "name": "",
        "type": "address",
    ...
    "inputs": [
      {
        "name": "category",
        "type": "uint8",
        "internalType": "enum IServiceRegistry.ServiceCategory"
      },
      {
        "name": "title",
        "type": "string",
    ...
    "outputs": [
      {
        "name": "",
        "type": "address",
        "internalType": "contract IDisputeArbitration"
      }
    ],
    "stateMutability": "view"
  },
    ...
    "outputs": [
      {
        ...
        "components": [
          ...
          },
          {
            "name": "status",
            "type": "uint8",
            "internalType": "enum IEscrowEngine.JobStatus"
          },
          {
            "name": "createdAt",
            "type": "uint256",
          ...
          },
          {
            "name": "escrowType",
            "type": "uint8",
            "internalType": "enum IEscrowEngine.EscrowType"
          },
          {
            "name": "skillId",
            "type": "uint256",
    ...
    "outputs": [
      {
        ...
        "components": [
          ...
          },
          {
            "name": "status",
            "type": "uint8",
            "internalType": "enum ILoanEngine.LoanStatus"
          },
          {
            "name": "term",
            "type": "uint8",
            "internalType": "enum ILoanEngine.LoanTerm"
          },
          {
            "name": "requestedAt",
            "type": "uint256",
    ...
    "outputs": [
      {
        ...
        "components": [
          ...
          },
          {
            "name": "status",
            "type": "uint8",
            "internalType": "enum IX402CreditFacility.CreditLineStatus"
          },
          {
            "name": "openedAt",
            "type": "uint256",
    ...
    "inputs": [
      {
        "name": "targetType",
        "type": "uint8",
        "internalType": "enum IRewardScheduler.TargetType"
      },
      {
        "name": "rewardToken",
        "type": "address",
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple[]",
        "internalType": "struct IRewardScheduler.Stream[]",
        "components": [
          {
            "name": "id",
            "type": "uint256",
    ...
    "outputs": [
      {
        "name": "",
        "type": "uint8",
        "internalType": "enum ILightningGovernor.ProposalStatus"
      }
    ],
    "stateMutability": "view"
  },
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct ILightningGovernor.Proposal",
        "components": [
          {
            "name": "id",
            "type": "uint256",
...
export const AirdropClaimABI = [
  ...
  {
    "type": "function",
    "name": "GOVERNANCE_VOTE_THRESHOLD",
    "inputs": [],
    "outputs": [
      {
        "name": "",
  ...
  },
  {
    ...
    "inputs": [
      ...
      },
      {
        "name": "milestone",
        "type": "uint8",
        "internalType": "enum IAirdropClaimV3.Milestone"
      }
    ],
    "outputs": [],
    "stateMutability": "nonpayable"
  ...
  },
  {
    ...
    "inputs": [
      ...
      {
        "name": "_approvalSigner",
        "type": "address",
        "internalType": "address"
      },
      {
        "name": "_claimWindowEnd",
        "type": "uint256",
        "internalType": "uint256"
      },
      {
        "name": "_difficultyTarget",
        "type": "uint256",
        "internalType": "uint256"
      },
      {
        "name": "_maxAirdropPool",
        "type": "uint256",
        "internalType": "uint256"
      },
      {
    ...
    "outputs": [
      {
        "name": "",
        "type": "address",
        "internalType": "contract Groth16VerifierV4"
      }
    ],
    "stateMutability": "view"
  },
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct IMultiPartyEscrow.JobGroup",
        "components": [
          {
            "name": "groupId",
            "type": "uint256",
    ...
    "outputs": [
      {
        "name": "",
        "type": "uint8",
        "internalType": "enum IMultiPartyEscrow.GroupStatus"
      }
    ],
    "stateMutability": "view"
  },
    ...
    "outputs": [
      {
        ...
        "components": [
          ...
          },
          {
            "name": "status",
            "type": "uint8",
            "internalType": "enum ISubscriptionEngine.SubscriptionStatus"
          },
          {
            "name": "listingId",
            "type": "uint256",
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct IBondingEngine.BondPosition",
        "components": [
          {
            "name": "marketId",
            "type": "uint256",
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct IBondingEngine.BondMarket",
        "components": [
          {
            "name": "quoteToken",
            "type": "address",
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct IDirectiveBoard.Directive",
        "components": [
          {
            "name": "id",
            "type": "uint256",
          ...
          },
          {
            "name": "directiveType",
            "type": "uint8",
            "internalType": "enum IDirectiveBoard.DirectiveType"
          },
          {
            "name": "poster",
            "type": "address",
          ...
          },
          {
            "name": "status",
            "type": "uint8",
            "internalType": "enum IDirectiveBoard.DirectiveStatus"
          },
          {
            "name": "createdAt",
            "type": "uint256",
...
export const RolePayrollABI = [
  ...
  {
    "type": "function",
    "name": "MAX_STRIKES_BEFORE_REMOVAL",
    "inputs": [],
    "outputs": [
      {
        "name": "",
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct IRolePayroll.EpochClaim",
        "components": [
          {
            "name": "claimed",
            "type": "bool",
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct IRolePayroll.RoleConfig",
        "components": [
          {
            "name": "maxSlots",
            "type": "uint16",
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct IRolePayroll.RoleSlot",
        "components": [
          {
            "name": "roleType",
            "type": "uint8",
            "internalType": "enum IRolePayroll.RoleType"
          },
          {
            "name": "rank",
            "type": "uint8",
            "internalType": "enum IRolePayroll.RoleRank"
          },
          {
            "name": "status",
            "type": "uint8",
            "internalType": "enum IRolePayroll.SlotStatus"
          },
          {
            "name": "enrolledAt",
            "type": "uint256",
  ...
  {
    "type": "function",
    "name": "recordDisputeParticipation",
    "inputs": [
      {
        "name": "arb",
        "type": "address",
    ...
    "outputs": [
      {
        "name": "",
        "type": "address",
        "internalType": "contract Groth16UptimeVerifier"
      }
    ],
    "stateMutability": "view"
  },
  ...
  {
    "type": "event",
    "name": "DisputeParticipationRecorded",
    "inputs": [
      {
        "name": "arb",
        "type": "address",
  ...
  {
    "type": "event",
    "name": "ResignationCooldownComplete",
    "inputs": [
      {
        "name": "holder",
        "type": "address",
...
export const X402EscrowBridgeABI = [
  ...
  {
    "type": "function",
    "name": "depositAndCreateJob",
    "inputs": [
      {
        "name": "intent",
        "type": "tuple",
        "internalType": "struct X402EscrowBridge.PaymentIntent",
        "components": [
          {
            "name": "x402Nonce",
            "type": "bytes32",
    ...
    "inputs": [
      {
        "name": "auth",
        "type": "tuple",
        "internalType": "struct X402EscrowBridge.ERC3009Auth",
        "components": [
          {
            "name": "from",
            "type": "address",
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct IPipelineRouter.Pipeline",
        "components": [
          {
            "name": "id",
            "type": "uint256",
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct IAffiliateManager.ReferralInfo",
        "components": [
          {
            "name": "referrer",
            "type": "address",
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct IAffiliateManager.ReferrerStats",
        "components": [
          {
            "name": "totalReferred",
            "type": "uint256",
  ...
  },
  {
    ...
    "inputs": [
      ...
      },
      {
        "name": "condition",
        "type": "uint8",
        "internalType": "enum ProductMarketplace.ProductCondition"
      },
      {
      ...
      },
      {
        "name": "listingType",
        "type": "uint8",
        "internalType": "enum ProductMarketplace.ListingType"
      }
    ],
    "outputs": [
      {
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct ProductMarketplace.Auction",
        "components": [
          {
            "name": "productId",
            "type": "uint256",
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct ProductMarketplace.Product",
        "components": [
          {
            "name": "id",
            "type": "uint256",
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct ProductMarketplace.ShipmentTracking",
        "components": [
          {
            "name": "jobId",
            "type": "uint256",
          ...
          },
          {
            "name": "status",
            "type": "uint8",
            "internalType": "enum ProductMarketplace.ShippingStatus"
          }
        ]
      }
    ],
  ...
  },
  {
    ...
    "inputs": [
      ...
      },
      {
        "name": "intent",
        "type": "tuple",
        "internalType": "struct ProductMarketplaceExtension.PaymentIntent",
        "components": [
          {
            "name": "x402Nonce",
            "type": "bytes32",
